...
export default function StatusCard({ color, icon, title, children ,link}) {
    return (
        ...
        <div className="w-full md:w-4/12 px-4 flex justify-center text-center py-4">
            <Card >
                <CardBody>
                    <div
                ...
                <a href={link}><button class="false items-center justify-center gap-1 font-bold outline-none uppercase tracking-wider focus:outline-none focus:shadow-none transition-all duration-300 rounded-lg py-3 px-7 text-sm leading-relaxed text-white bg-light-blue-500 hover:bg-light-blue-700 focus:bg-light-blue-400 active:bg-light-blue-800 shadow-md-light-blue hover:shadow-lg-light-blue undefined" >Start Lab</button></a>
            </Card>
        </div>
    );
}
